...
class SpectatorControllerTest {
    ...
    @Test
    void createSpectator_shouldReturnConflictWhenEmailAlreadyExists() throws Exception {
    SpectatorRequest request = new SpectatorRequest(
        "Alice Martin",
        "alice@example.com",
        LocalDate.of(1990, 4, 12),
    ...
    when(spectatorService.createSpectator(any(SpectatorRequest.class)))
        .thenThrow(new BusinessConflictException("Email déjà utilisé"));
